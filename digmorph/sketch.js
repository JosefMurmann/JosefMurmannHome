...
function preload() {
  ...
  dig = loadImage("pog.png");
  dig2 = loadImage("react.png");
  dig3 = loadImage("coral.png");
...
function sph() {
  ...
  text("Reaction Diffusion", 0, 80, 10);
...
function cyl() {
  ...
  text("Differential Growth", 0, 80, 10);
...
function bx() {
  ...
  text("Diffusion-limited aggregation", 0, 80, 10);
